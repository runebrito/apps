...
if($lastInsertId)
{
$msg="Baja enviada satisfactoriamente !";
}
else 
{
$error="Algo hubo mal, repita el proceso !";
}
...
<html lang="en">
    <head>
        ...
        <!-- online  -->
        <title>Empleado | Aplicar Baja</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Introducir baja</div>
                    </div>
     ...
     <?php if($error){?><div class="errorWrap"><strong>ERROR </strong>:<?php echo htmlentities($error); ?> </div><?php } 
                else if($msg){?><div class="succWrap"><strong>PERFECTO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>


 <div class="input-field col  s12">
<select  name="leavetype" autocomplete="off">
<option value="">Seleccione el tipo de Baja...</option>
...
<div class="input-field col m6 s12">
<label for="todate">Fecha límite</label>
...
<textarea id="textarea1" name="description" class="materialize-textarea" length="500" required></textarea>
      ...
      <button type="submit" name="apply" id="apply" class="waves-effect waves-light btn indigo m-b-xs">Enviar</button>                                             
