...
<html lang="en">
    ...
    <!-- online  -->    
        ...
        <title>Administrador | Bajas Detalles </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">Información detallada de la baja</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Baja detalles</span>
                                <?php if($msg){?><div class="succWrap"><strong>PERFECTO</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Nombre empleado :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>DNI :</b></td>
                                          ...
                                          <tr>
                                            ...
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Télefono:</b></td>
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Baja tipo :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Tiempo de baja :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Descripcion de la baja : </b></td>
                                            <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                        </tr>

<tr>
<td style="font-size:16px;"><b>Baja status :</b></td>
...
<?php } if($stats==0)  { ?>
 <span style="color: blue">Aprovación en Espera</span>
 <?php } ?>
</td>
</tr>

<tr>
<td style="font-size:16px;"><b>Administrador Observaciones: </b></td>
<td colspan="5"><?php
...
?></td>
 ...
 <tr>
<td style="font-size:16px;"><b>fechas de entrada: </b></td>
<td colspan="5"><?php
...
<tr>
 <td colspan="5">
  <a class="modal-trigger waves-effect waves-light btn" href="#modal1">Enviar&nbsp;acción</a>
<form name="adminaction" method="post">
<div id="modal1" class="modal modal-fixed-footer" style="height: 60%">
    <div class="modal-content" style="width:90%">
        <h4>Seleccione acción</h4>
