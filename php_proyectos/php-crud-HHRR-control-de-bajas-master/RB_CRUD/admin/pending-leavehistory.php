...
<html lang="en">
    <head>
        ...
        <!-- Título -->
        <title>Admin | Bajas Pendientes</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Bajas Pendientes</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Historial de bajas por aprobar</span>
...
if($stats==1){
                                             ?>
                                                 ...
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">No Aprovada</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">Por aprobar</span>
 <?php } ?>
