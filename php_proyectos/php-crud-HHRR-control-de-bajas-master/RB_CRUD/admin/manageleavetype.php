...
$query -> execute();
$msg="Tipo de Baja eliminada con éxito";
...
<html lang="en">
    <head>
        ...
        <!-- Título -->
        <title>Administrador | Tipos de bajas</title>
        
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
        <meta charset="UTF-8">
        <meta name="description" content="RBN" />
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Tipos de bajas</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Definicion y creacion de bajas</span>
