                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Registro de empleados</span>
...
?>                            
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Tipos de Bajas</span>
                                    <?php
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">Última actividad de las bajas </span>
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">No aprobada</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">En espera</span>
 <?php } ?>
