...
<html lang="en">
    <head>
        ...
        <!-- Titulo -->
        <title>Administrador | Bajas aprovadas </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Bajas aprobadas</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Historial de bajas aprobadas</span>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="120">Tipo de Baja</th>
                                             ...
                                             <th width="180">Fecha de entrada</th>                 
                                            <th>Estado</th>
                                            <th align="center"></th>
                                        </tr>
                                    </thead>
