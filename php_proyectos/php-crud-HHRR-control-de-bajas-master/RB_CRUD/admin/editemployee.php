...
$query->execute();
$msg="Registro del empleado actualizado con exito !";
}
...
<html lang="en">
    <head>
        ...
        <!-- Título -->
        <title>Administrador | Editar empleados</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Editar empleados</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h3>Información actual para la edición</h3>
...
<label for="empcode">Codigo del empleado (Debe ser unico)</label>
...
<div class="input-field col m6 s12">
<label for="city">Sector/Población</label>
