...
public class server_frame extends javax.swing.JFrame 
{
   ...
   public class ClientHandler implements Runnable	
   {
       ...
       public void run() 
       {
            String message, connect = "Connectado", disconnect = "Desconectado", chat = "Chat" ;
            String[] data;
            ...
            try 
            {
                while ((message = reader.readLine()) != null) 
                {
                    ...
                    {
                        tellEveryone((data[0] + ":ha desconectado." + ":" + chat));
                        userRemove(data[0]);
                    } 
                    ...
                    {
                        ta_chat.append("No se cumplieron condiciones. \n");
                    }
                } 
             } 
             catch (Exception ex) 
    ...
    private void initComponents() {
        ...
        b_users.setText("Usuarion Online");
        ...
        jLabel1.setText("RBN CHAT - SERVIDOR");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(b_start, javax.swing.GroupLayout.DEFAULT_SIZE, 92, Short.MAX_VALUE)
    ...
    private void b_startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_startActionPerformed
        ...
        ta_chat.append("El servidor ya está iniciado...\n");
    ...
    public class ServerStart implements Runnable 
    {
        ...
        public void run() 
        {
            ...
            {
                ta_chat.append("Erroro realizando la conexión. \n");
            }
        }
    }
	...
	Iterator it = clientOutputStreams.iterator();
		...
		ta_chat.append("Enviando: " + message + "\n");
            ...
            {
		ta_chat.append("Error al comunicarle a todos. \n");
            }
        } 
    }
